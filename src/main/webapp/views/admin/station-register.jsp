...
<%@ page import="com.quanlytau.model.bean.Station" %>
<%
...
<div class="container">
    ...
    <form method="post" action="/admin/station">
        ...
        <div class="form-row">
            <label for="stationId">Mã ga:</label>
            <input type="text" id="stationId" name="stationId" value="<%= isEdit ? station.getStationId() : "" %>" <%= isEdit ? "readonly" : "" %> required />
        </div>
        <div class="form-row">
            <label for="name">Tên ga:</label>
            <input type="text" id="name" name="name" value="<%= isEdit ? station.getName() : "" %>" required />
        </div>
        <div class="form-row">
            <label for="address">Địa chỉ:</label>
            <input type="text" id="address" name="address" value="<%= isEdit ? station.getAddress() : "" %>" required />
        </div>
